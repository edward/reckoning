...
describe Invoice do
  ...
  it "should generate a new number if none exists already" do
  end
  
  describe "#generate_new_number" do
    it "should generate a unique new invoice number per the user’s settings" do
    end
  end
end
